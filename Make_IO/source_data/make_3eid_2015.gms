...
$include .%fs%set%fs%basic_code_2015.gms
...
;
$onecho > command.txt
i=.%fs%source_data%fs%3EID_2015.xlsx o=.%fs%source_data%fs%3EID_2015.gdx
par=co2_temp rng=CO2!D5:BI399 rdim=1 cdim=1
par=co2_ne_temp rng=neCO2!D5:EO399 rdim=1 cdim=1
$offecho
$if not %recreate%==0 $call '=gdxxrw @command.txt';

$gdxin .%fs%source_data%fs%3EID_2015.gdx
$load co2_temp
$load co2_ne_temp

display co2_temp, co2_ne_temp;
...
0611011.(1,2,3,4,5,6)   石炭
0611012.(14,15,16,17,18,19,20)      原油
0611013.(46,47,48,49)   天然ガス
2111011.30              ガソリン
...
$offtext
execute_unload '.%fs%data%fs%japan_io_2015_co2.gdx', iotable_co2_data, iotable_co2_data_ne;
